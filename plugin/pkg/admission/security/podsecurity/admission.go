...
var (
	// TODO: move to k8s.io/pod-security-policy/admission?
	applicableResources = map[schema.GroupResource]map[string]bool{
...
func (p *Plugin) Validate(ctx context.Context, a admission.Attributes, o admission.ObjectInterfaces) error {
	...
	if !applicableResources[gr][a.GetSubresource()] && !p.delegate.PodSpecExtractor.HasPodSpec(gr) {
		return nil
	}
...
func convert(obj runtime.Object) runtime.Object {
	...
	case *core.Namespace:
		...
		if err := v1.Convert_core_Namespace_To_v1_Namespace(obj, v1Namespace, nil); err != nil {
	...
	case *core.Pod:
		v1Pod := &corev1.Pod{}
		if err := v1.Convert_core_Pod_To_v1_Pod(obj, v1Pod, nil); err != nil {
			utilruntime.HandleError(err)
			return nil
		}
		return v1Pod
	default:
		// TODO: podtemplate, etc
