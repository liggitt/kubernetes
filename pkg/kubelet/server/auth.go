...
func NewKubeletAuth(authenticator authenticator.Request, authorizerAttributeGetter NodeRequestAttributesGetter, authorizer authorizer.Authorizer, clientCA dynamiccertificates.CAContentProvider) AuthInterface {
	return &KubeletAuth{authenticator, authorizerAttributeGetter, authorizer, clientCA}
}
