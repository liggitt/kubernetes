...
func (in *InlineExpression) DeepCopyInto(out *InlineExpression) {
	*out = *in
	if in.CEL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InlineExpression.
func (in *InlineExpression) DeepCopy() *InlineExpression {
	if in == nil {
		return nil
	}
	out := new(InlineExpression)
	in.DeepCopyInto(out)
	return out
}
