...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*v1beta1.InlineExpression)(nil), (*admissionregistration.InlineExpression)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_InlineExpression_To_admissionregistration_InlineExpression(a.(*v1beta1.InlineExpression), b.(*admissionregistration.InlineExpression), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*admissionregistration.InlineExpression)(nil), (*v1beta1.InlineExpression)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_admissionregistration_InlineExpression_To_v1beta1_InlineExpression(a.(*admissionregistration.InlineExpression), b.(*v1beta1.InlineExpression), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_InlineExpression_To_admissionregistration_InlineExpression(in *v1beta1.InlineExpression, out *admissionregistration.InlineExpression, s conversion.Scope) error {
	out.CEL = (*string)(unsafe.Pointer(in.CEL))
	return nil
}

// Convert_v1beta1_InlineExpression_To_admissionregistration_InlineExpression is an autogenerated conversion function.
func Convert_v1beta1_InlineExpression_To_admissionregistration_InlineExpression(in *v1beta1.InlineExpression, out *admissionregistration.InlineExpression, s conversion.Scope) error {
	return autoConvert_v1beta1_InlineExpression_To_admissionregistration_InlineExpression(in, out, s)
}

func autoConvert_admissionregistration_InlineExpression_To_v1beta1_InlineExpression(in *admissionregistration.InlineExpression, out *v1beta1.InlineExpression, s conversion.Scope) error {
	out.CEL = (*string)(unsafe.Pointer(in.CEL))
	return nil
}

// Convert_admissionregistration_InlineExpression_To_v1beta1_InlineExpression is an autogenerated conversion function.
func Convert_admissionregistration_InlineExpression_To_v1beta1_InlineExpression(in *admissionregistration.InlineExpression, out *v1beta1.InlineExpression, s conversion.Scope) error {
	return autoConvert_admissionregistration_InlineExpression_To_v1beta1_InlineExpression(in, out, s)
}
...
func autoConvert_v1beta1_MutatingWebhook_To_admissionregistration_MutatingWebhook(in *v1beta1.MutatingWebhook, out *admissionregistration.MutatingWebhook, s conversion.Scope) error {
	...
	out.Expression = (*admissionregistration.InlineExpression)(unsafe.Pointer(in.Expression))
	return nil
}
...
func autoConvert_admissionregistration_MutatingWebhook_To_v1beta1_MutatingWebhook(in *admissionregistration.MutatingWebhook, out *v1beta1.MutatingWebhook, s conversion.Scope) error {
	...
	out.Expression = (*v1beta1.InlineExpression)(unsafe.Pointer(in.Expression))
	return nil
}
