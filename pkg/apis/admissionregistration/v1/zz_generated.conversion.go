...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*v1.InlineExpression)(nil), (*admissionregistration.InlineExpression)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_InlineExpression_To_admissionregistration_InlineExpression(a.(*v1.InlineExpression), b.(*admissionregistration.InlineExpression), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*admissionregistration.InlineExpression)(nil), (*v1.InlineExpression)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_admissionregistration_InlineExpression_To_v1_InlineExpression(a.(*admissionregistration.InlineExpression), b.(*v1.InlineExpression), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_InlineExpression_To_admissionregistration_InlineExpression(in *v1.InlineExpression, out *admissionregistration.InlineExpression, s conversion.Scope) error {
	out.CEL = (*string)(unsafe.Pointer(in.CEL))
	return nil
}

// Convert_v1_InlineExpression_To_admissionregistration_InlineExpression is an autogenerated conversion function.
func Convert_v1_InlineExpression_To_admissionregistration_InlineExpression(in *v1.InlineExpression, out *admissionregistration.InlineExpression, s conversion.Scope) error {
	return autoConvert_v1_InlineExpression_To_admissionregistration_InlineExpression(in, out, s)
}

func autoConvert_admissionregistration_InlineExpression_To_v1_InlineExpression(in *admissionregistration.InlineExpression, out *v1.InlineExpression, s conversion.Scope) error {
	out.CEL = (*string)(unsafe.Pointer(in.CEL))
	return nil
}

// Convert_admissionregistration_InlineExpression_To_v1_InlineExpression is an autogenerated conversion function.
func Convert_admissionregistration_InlineExpression_To_v1_InlineExpression(in *admissionregistration.InlineExpression, out *v1.InlineExpression, s conversion.Scope) error {
	return autoConvert_admissionregistration_InlineExpression_To_v1_InlineExpression(in, out, s)
}
...
func autoConvert_admissionregistration_MutatingWebhook_To_v1_MutatingWebhook(in *admissionregistration.MutatingWebhook, out *v1.MutatingWebhook, s conversion.Scope) error {
	...
	out.Expression = (*v1.InlineExpression)(unsafe.Pointer(in.Expression))
	return nil
}
