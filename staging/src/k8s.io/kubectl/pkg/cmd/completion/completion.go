...
func runCompletionBash(out io.Writer, boilerPlate string, kubectl *cobra.Command) error {
	...
	return kubectl.GenBashCompletionV2(out, false) // TODO: Upgrade to Cobra 1.3.0 or later before including descriptions (See https://github.com/liggitt/cobra/pull/1509)
}
