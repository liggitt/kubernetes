...
// for bilding nice-looking higher-level error reporting.
...
// value.
func TooLong(field *Path, value interface{}, maxBytes int) *Error {
	return &Error{ErrorTypeTooLong, field.String(), value, fmt.Sprintf("must have at most %d bytes", maxBytes)}
}
