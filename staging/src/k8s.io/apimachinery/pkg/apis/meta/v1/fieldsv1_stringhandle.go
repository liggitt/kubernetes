//go:build !(fieldsv1_byte || fieldsv1_string)
...
type FieldsV1 struct {
	...
	raw unique.Handle[string] `json:"-" protobuf:"bytes,1,opt,name=Raw"`
	set bool
}
...
func NewFieldsV1(raw string) *FieldsV1 {
	return &FieldsV1{set: true, raw: unique.Make(raw)}
}
