...
var map_CreateOptions = map[string]string{
	...
	"fieldValidation": "fieldValidation determines how the server should respond to unknown/duplicate fields in the object in the request. Introduced in 1.23, older servers will ignore this param and not perform any server side field validation.",
}
...
var map_PatchOptions = map[string]string{
	...
	"fieldValidation": "fieldValidation determines how the server should respond to unknown/duplicate fields in the patch. Introduced in 1.23, older servers will ignore this param and not perform any server side field validation.",
}
...
var map_UpdateOptions = map[string]string{
	...
	"dryRun":          "When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed",
	"fieldManager":    "fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.",
	"fieldValidation": "fieldValidation determines how the server should respond to unknown/duplicate fields in the object in the update. Introduced in 1.23, older servers will ignore this param and not perform any server side field validation.",
}
