...
func NewEnvelopeTransformer(envelopeService Service, cacheSize int, baseTransformerFunc func(cipher.Block) value.Transformer, pluginName string) (value.Transformer, error) {
	var cache *lru.Cache
