...
type MatcherMetrics interface {
	...
	// RecordAuthorizationMatchConditionEvaluationFailure increments if an evaluation error was encountered evaluating matchConditions for an Authorize() call to the given authorizer
